...
export const ALL_PRODUCTS: Record<string, ProductItem> = {
  ...
  'dji-1': { id: 'dji-1', name: 'DJI Pocket 3', category: 'undefined', price: '₹1799', extraDayPrice: '₹500/day', rating: 4.5, reviews: 0, imageUrl: img_photo_33, description: 'DJI Pocket 3', specs: [] },
